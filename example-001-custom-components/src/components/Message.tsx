          ...
          <div className="message-body">
            {isEditing ? (
              ...
              <>
                ...
                {(message.customComponent || message.componentName) ? (
                  <div className="message-custom-component">
                    {(() => {
                      // Try inline component first
                      if (message.customComponent) {
                        const CustomComponent = message.customComponent
                        return <CustomComponent {...(message.componentProps || {})} />
                      }

                      // Try registry component
                      if (message.componentName) {
                        const RegisteredComponent = getComponent(message.componentName)
                        if (RegisteredComponent) {
                          return <RegisteredComponent {...(message.componentProps || {})} />
                        } else {
                          console.warn(`Component "${message.componentName}" not found in registry`)
                          return (
                            <div className="message-component-error">
                              Component "{message.componentName}" not found
                            </div>
                          )
                        }
                      }
            ...
            <div className={`message-actions ${isHovered || showActions ? 'is-visible' : ''}`}>
              ...
              {isAssistant && onReaction && (
                <>
                  ...
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      <path d="M10 15v4a3 3 0 003 3l4-9V2H5.72a2 2 0 00-2 1.7l-1.38 9a2 2 0 002 2.3zm7-13h2.67A2.31 2.31 0 0122 4v7a2.31 2.31 0 01-2.33 2H17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                </>
              )}
